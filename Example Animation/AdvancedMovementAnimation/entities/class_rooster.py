...
class Rooster(SpriteBase):
    def __init__(self):
        super(Rooster, self).__init__()
        self.ImageSource(pygame.image.load('images/Animal.png'))
        
        #looking north
        self.HotSpots(pygame.Rect(224, 96, 32, 32)) #standing
        self.HotSpots(pygame.Rect(192, 96, 32, 32)) #step right foot
        self.HotSpots(pygame.Rect(256, 96, 32, 32)) #step left foot
        
        #looking east
        self.HotSpots(pygame.Rect(224, 64, 32, 32)) #standing
        self.HotSpots(pygame.Rect(192, 64, 32, 32)) #step right foot
        self.HotSpots(pygame.Rect(256, 64, 32, 32)) #step left foot
        
        #looking west
        self.HotSpots(pygame.Rect(224, 32, 32, 32)) #standing
        self.HotSpots(pygame.Rect(256, 32, 32, 32)) #step right foot
        self.HotSpots(pygame.Rect(192, 32, 32, 32)) #step left foot
        
        #looking south
        self.HotSpots(pygame.Rect(224, 0, 32, 32)) #standing
        self.HotSpots(pygame.Rect(192, 0, 32, 32)) #step right foot
        self.HotSpots(pygame.Rect(256, 0, 32, 32)) #step left foot
