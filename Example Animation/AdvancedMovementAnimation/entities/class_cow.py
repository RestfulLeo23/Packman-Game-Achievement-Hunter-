...
class Cow(SpriteBase):
    def __init__(self):
        super(Cow, self).__init__()
        self.ImageSource(pygame.image.load('images/Animal.png'))
        
        #looking north
        self.HotSpots(pygame.Rect(32, 224, 32, 32)) #standing
        self.HotSpots(pygame.Rect(0, 224, 32, 32)) #step right foot
        self.HotSpots(pygame.Rect(64, 224, 32, 32)) #step left foot
        
        #looking east
        self.HotSpots(pygame.Rect(32, 192, 32, 32)) #standing
        self.HotSpots(pygame.Rect(0, 192, 32, 32)) #step right foot
        self.HotSpots(pygame.Rect(64, 192, 32, 32)) #step left foot
        
        #looking west
        self.HotSpots(pygame.Rect(32, 160, 32, 32)) #standing
        self.HotSpots(pygame.Rect(64, 160, 32, 32)) #step right foot
        self.HotSpots(pygame.Rect(0, 160, 32, 32)) #step left foot
        
        #looking south
        self.HotSpots(pygame.Rect(32, 128, 32, 32)) #standing
        self.HotSpots(pygame.Rect(0, 128, 32, 32)) #step right foot
        self.HotSpots(pygame.Rect(64, 128, 32, 32)) #step left foot
